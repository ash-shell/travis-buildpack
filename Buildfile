...
printf "$MODULE_REPO_NAME" >> ash/global_modules/module_aliases.yaml
printf ":" >> ash/global_modules/module_aliases.yaml
printf " github.com/ash-shell/$MODULE_REPO_NAME" >> ash/global_modules/module_aliases.yaml
cd ash
echo $(pwd)
